...
import com.bsiag.anagnostes.demoapp.server.nn.configuration.ConfigurationFactory;
import com.bsiag.anagnostes.demoapp.server.nn.util.ImageUtility;
import com.bsiag.anagnostes.demoapp.shared.hcr.Output;
import com.bsiag.anagnostes.demoapp.shared.hcr.OutputEntry;
...
public class NeuralNetwork {
	...
	public Output output(BufferedImage image) {
		...
		for (int i = 0; i < ConfigurationFactory.NUM_OUTPUTS; i++) {
