...
import com.bsiag.anagnostes.demoapp.shared.hcr.ITestPersonLookupService;

public class TestPersonLookupService extends AbstractLookupService<String> implements ITestPersonLookupService {
